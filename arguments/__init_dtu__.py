...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.multi_view_pixel_noise_th_end_iter = 30000
        ...
        # DPT loss parameters
        self.dpt_loss_from_iter = 7000
        self.dpt_end_iter = 25000
        self.depth_l1_weight_init = 4.0 #4.0
        self.depth_l1_weight_final = 2.0 #2.5
        self.depth_l1_loss_scale = 0.5
        ...
        self.depth_direction_consistency_weight = 0.5
        
        # Quadtree depth alignment parameters
        self.use_quadtree_depth_alignment = False
        self.quadtree_level0_end_iter = 10000
        self.quadtree_level1_end_iter = 15000
        self.quadtree_level2_end_iter = 20000
        ...
        self.opacity_loss_from_iter = 7000
        self.opacity_loss_end_iter = 30000

        # GS Opacity loss parameters
        self.use_gs_opacity_loss = False
        self.gs_opacity_loss_weight = 0.001
        self.gs_opacity_loss_from_iter = 10000
