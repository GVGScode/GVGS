...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, infl, radii, out_observe, out_all_map, out_plane_depth, out_opacity, out_accT_masked, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, infl, radii, out_observe, out_all_map, out_plane_depth, out_opacity, out_accT_masked

    @staticmethod
    def backward(ctx, grad_out_color, grad_infl, grad_radii, grad_out_observe, grad_out_all_map, grad_out_plane_depth, grad_out_opacity, grad_out_accT_masked):
...
class GaussianRasterizationSettings(NamedTuple):
    ...
    debug : bool
    get_infl : bool
    gaussian_mask : torch.Tensor = torch.Tensor([])
